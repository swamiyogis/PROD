...
function TermsAndConditions() {
  return (
    <div className={styles["terms-container"]}>
      <h1 className={styles["terms-heading"]}>Terms & Conditions</h1>
      ...
      <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://swamiyogi.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
      <p>The Platform is owned by Swamiyogi, a company incorporated under the Companies Act, 1956 with its registered office at 401, 4th floor, sai siddhi chs, ploat number 55, sector 18, Kharghar, Navi Mumbai, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
      ...
      <p>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Navi Mumbai and Maharashtra.</p>
